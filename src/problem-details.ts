/**
 * Problem Details types, StandardError registry, and converters.
 *
 ...
 * standard diagnostic fields and this package's timestamp extension. The
 * package generates a canonical UTC ISO 8601 timestamp when callers omit one;
 * caller-supplied timestamps are preserved unchanged.
 */
...
export class StandardError {
   ...
   * @param timestamp - Optional caller-supplied diagnostic timestamp, preserved unchanged; when omitted, the package generates a canonical UTC ISO 8601 timestamp.
